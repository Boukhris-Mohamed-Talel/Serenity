...
public class AppointmentController {
    ...
    public ResponseEntity<List<CalendarBusySlotResponse>> calendarHints(
        ...
        if (AppointmentAuth.isPatient()) {
            ...
            return ResponseEntity.ok(appointmentService.calendarHintsForPatient(uid, doctorUserId, from, to));
        }
        if (AppointmentAuth.isDoctor()) {
            return ResponseEntity.ok(appointmentService.calendarHintsForDoctor(uid, patientUserId, from, to));
        }
