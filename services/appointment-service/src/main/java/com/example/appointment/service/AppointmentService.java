...
public interface AppointmentService {
     ...
     */
    List<CalendarBusySlotResponse> calendarHintsForPatient(Long patientUserId, Long doctorUserId, LocalDate from, LocalDate to);

    List<CalendarBusySlotResponse> calendarHintsForDoctor(Long doctorUserId, Long patientUserIdOrNull, LocalDate from, LocalDate to);
}
